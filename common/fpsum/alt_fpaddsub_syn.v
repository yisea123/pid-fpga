...
//altfp_add_sub DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone II" DIRECTION="VARIABLE" OPTIMIZE="SPEED" PIPELINE=7 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 aclr add_sub clk_en clock dataa datab nan overflow result underflow zero
...
module  alt_fpaddsub_altbarrel_shift
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //alt_fpaddsub_altbarrel_shift
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altbarrel_shift1
	( 
	data,
	distance,
	result) /* synthesis synthesis_clearbox=1 */;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //alt_fpaddsub_altbarrel_shift1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder1234
	( 
	data,
	q,
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //alt_fpaddsub_altpriority_encoder1234

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder123
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	alt_fpaddsub_altpriority_encoder1234   altpriority_encoder13
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	alt_fpaddsub_altpriority_encoder1234   altpriority_encoder14
	( 
	.data(data[3:2]),
...
endmodule //alt_fpaddsub_altpriority_encoder123

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder12
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	alt_fpaddsub_altpriority_encoder123   altpriority_encoder11
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	alt_fpaddsub_altpriority_encoder123   altpriority_encoder12
	( 
	.data(data[7:4]),
...
endmodule //alt_fpaddsub_altpriority_encoder12
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder1234567
	( 
	data,
	...
	assign
		q = {data[1]};
endmodule //alt_fpaddsub_altpriority_encoder1234567

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder123456
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [3:0]  data;
	...
	alt_fpaddsub_altpriority_encoder1234567   altpriority_encoder17
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder17_q));
	alt_fpaddsub_altpriority_encoder1234   altpriority_encoder18
	( 
	.data(data[3:2]),
...
endmodule //alt_fpaddsub_altpriority_encoder123456

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder12345
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [7:0]  data;
	...
	alt_fpaddsub_altpriority_encoder123456   altpriority_encoder15
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder15_q));
	alt_fpaddsub_altpriority_encoder123   altpriority_encoder16
	( 
	.data(data[7:4]),
...
endmodule //alt_fpaddsub_altpriority_encoder12345

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder1
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [15:0]  data;
	...
	alt_fpaddsub_altpriority_encoder12   altpriority_encoder10
	( 
	.data(data[15:8]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	alt_fpaddsub_altpriority_encoder12345   altpriority_encoder9
	( 
	.data(data[7:0]),
...
endmodule //alt_fpaddsub_altpriority_encoder1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder12345678
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	alt_fpaddsub_altpriority_encoder12   altpriority_encoder19
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder19_q),
	.zero(wire_altpriority_encoder19_zero));
	alt_fpaddsub_altpriority_encoder12   altpriority_encoder20
	( 
	.data(data[15:8]),
...
endmodule //alt_fpaddsub_altpriority_encoder12345678

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [31:0]  data;
	...
	alt_fpaddsub_altpriority_encoder1   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	alt_fpaddsub_altpriority_encoder12345678   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //alt_fpaddsub_altpriority_encoder
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder12345678910111213
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	assign
		q = {(~ data[0])},
		zero = (~ (data[0] | data[1]));
endmodule //alt_fpaddsub_altpriority_encoder12345678910111213

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder123456789101112
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	alt_fpaddsub_altpriority_encoder12345678910111213   altpriority_encoder27
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder27_q),
	.zero(wire_altpriority_encoder27_zero));
	alt_fpaddsub_altpriority_encoder12345678910111213   altpriority_encoder28
	( 
	.data(data[3:2]),
...
endmodule //alt_fpaddsub_altpriority_encoder123456789101112

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder1234567891011
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	alt_fpaddsub_altpriority_encoder123456789101112   altpriority_encoder25
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder25_q),
	.zero(wire_altpriority_encoder25_zero));
	alt_fpaddsub_altpriority_encoder123456789101112   altpriority_encoder26
	( 
	.data(data[7:4]),
...
endmodule //alt_fpaddsub_altpriority_encoder1234567891011

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder12345678910
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	alt_fpaddsub_altpriority_encoder1234567891011   altpriority_encoder23
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	alt_fpaddsub_altpriority_encoder1234567891011   altpriority_encoder24
	( 
	.data(data[15:8]),
...
endmodule //alt_fpaddsub_altpriority_encoder12345678910
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder1234567891011121314151617
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [1:0]  data;
	...
	assign
		q = {(~ data[0])};
endmodule //alt_fpaddsub_altpriority_encoder1234567891011121314151617

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder12345678910111213141516
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [3:0]  data;
	...
	alt_fpaddsub_altpriority_encoder12345678910111213   altpriority_encoder33
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder33_q),
	.zero(wire_altpriority_encoder33_zero));
	alt_fpaddsub_altpriority_encoder1234567891011121314151617   altpriority_encoder34
	( 
	.data(data[3:2]),
...
endmodule //alt_fpaddsub_altpriority_encoder12345678910111213141516

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder123456789101112131415
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [7:0]  data;
	...
	alt_fpaddsub_altpriority_encoder123456789101112   altpriority_encoder31
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder31_q),
	.zero(wire_altpriority_encoder31_zero));
	alt_fpaddsub_altpriority_encoder12345678910111213141516   altpriority_encoder32
	( 
	.data(data[7:4]),
...
endmodule //alt_fpaddsub_altpriority_encoder123456789101112131415

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder1234567891011121314
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [15:0]  data;
	...
	alt_fpaddsub_altpriority_encoder1234567891011   altpriority_encoder29
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder29_q),
	.zero(wire_altpriority_encoder29_zero));
	alt_fpaddsub_altpriority_encoder123456789101112131415   altpriority_encoder30
	( 
	.data(data[15:8]),
...
endmodule //alt_fpaddsub_altpriority_encoder1234567891011121314

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altpriority_encoder123456789
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [31:0]  data;
	...
	alt_fpaddsub_altpriority_encoder12345678910   altpriority_encoder21
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	alt_fpaddsub_altpriority_encoder1234567891011121314   altpriority_encoder22
	( 
	.data(data[31:16]),
...
endmodule //alt_fpaddsub_altpriority_encoder123456789
...
`endif
	...
	assign
		result = lcell_ffa;
endmodule //alt_fpaddsub_add_sub
...
`endif
	...
	assign
		...
		cout_wire = cout_regr,
		result = lcell_ffa;
endmodule //alt_fpaddsub_add_sub1
...
`endif
	...
	assign
		result = lcell_ffa;
endmodule //alt_fpaddsub_add_sub12
...
//synthesis_resources = lut 170 reg 382 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_fpaddsub_altfp_add_sub
	( 
	aclr,
	add_sub,
	clk_en,
...
`endif
	...
	alt_fpaddsub_altbarrel_shift   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	alt_fpaddsub_altbarrel_shift1   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	alt_fpaddsub_altpriority_encoder   leading_zeroes_cnt
	( 
	.data({man_add_sub_res_mag_dffe21_wo[25:1], 1'b1, {6{1'b0}}}),
	.q(wire_leading_zeroes_cnt_q));
	alt_fpaddsub_altpriority_encoder123456789   trailing_zeros_cnt
	( 
	...
	alt_fpaddsub_add_sub1   man_2comp_res_lower
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(borrow_w),
	...
	alt_fpaddsub_add_sub12   man_2comp_res_upper0
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b0),
	...
	alt_fpaddsub_add_sub12   man_2comp_res_upper1
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b1),
	...
	alt_fpaddsub_add_sub1   man_add_sub_lower
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(borrow_w),
	...
	alt_fpaddsub_add_sub12   man_add_sub_upper0
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b0),
	...
	alt_fpaddsub_add_sub12   man_add_sub_upper1
	( 
	.aclr(aclr),
	.add_sub(add_sub_w2),
	.cin(1'b1),
...
endmodule //alt_fpaddsub_altfp_add_sub
//VALID FILE
...
module alt_fpaddsub (
	...
	alt_fpaddsub_altfp_add_sub	alt_fpaddsub_altfp_add_sub_component (
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),

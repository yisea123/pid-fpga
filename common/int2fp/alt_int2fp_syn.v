...
//altfp_convert DEVICE_FAMILY="Cyclone II" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 aclr clk_en clock dataa result
...
module  alt_int2fp_altbarrel_shift
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //alt_int2fp_altbarrel_shift
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_int2fp_altpriority_encoder1234
	( 
	data,
	q,
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //alt_int2fp_altpriority_encoder1234

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_int2fp_altpriority_encoder123
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	alt_int2fp_altpriority_encoder1234   altpriority_encoder15
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	alt_int2fp_altpriority_encoder1234   altpriority_encoder16
	( 
	.data(data[3:2]),
...
endmodule //alt_int2fp_altpriority_encoder123

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_int2fp_altpriority_encoder12
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	alt_int2fp_altpriority_encoder123   altpriority_encoder13
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	alt_int2fp_altpriority_encoder123   altpriority_encoder14
	( 
	.data(data[7:4]),
...
endmodule //alt_int2fp_altpriority_encoder12

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_int2fp_altpriority_encoder1
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	alt_int2fp_altpriority_encoder12   altpriority_encoder11
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	alt_int2fp_altpriority_encoder12   altpriority_encoder12
	( 
	.data(data[15:8]),
...
endmodule //alt_int2fp_altpriority_encoder1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_int2fp_altpriority_encoder12345678
	( 
	data,
	...
	assign
		q = {data[1]};
endmodule //alt_int2fp_altpriority_encoder12345678

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_int2fp_altpriority_encoder1234567
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [3:0]  data;
	...
	alt_int2fp_altpriority_encoder12345678   altpriority_encoder21
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder21_q));
	alt_int2fp_altpriority_encoder1234   altpriority_encoder22
	( 
	.data(data[3:2]),
...
endmodule //alt_int2fp_altpriority_encoder1234567

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_int2fp_altpriority_encoder123456
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [7:0]  data;
	...
	alt_int2fp_altpriority_encoder1234567   altpriority_encoder19
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder19_q));
	alt_int2fp_altpriority_encoder123   altpriority_encoder20
	( 
	.data(data[7:4]),
...
endmodule //alt_int2fp_altpriority_encoder123456

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_int2fp_altpriority_encoder12345
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [15:0]  data;
	...
	alt_int2fp_altpriority_encoder123456   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	alt_int2fp_altpriority_encoder12   altpriority_encoder18
	( 
	.data(data[15:8]),
...
endmodule //alt_int2fp_altpriority_encoder12345

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_int2fp_altpriority_encoder
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [31:0]  data;
	...
	alt_int2fp_altpriority_encoder1   altpriority_encoder10
	( 
	.data(data[31:16]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	alt_int2fp_altpriority_encoder12345   altpriority_encoder9
	( 
	.data(data[15:0]),
...
endmodule //alt_int2fp_altpriority_encoder
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  alt_int2fp_altfp_convert
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	alt_int2fp_altbarrel_shift   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	alt_int2fp_altpriority_encoder   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //alt_int2fp_altfp_convert
//VALID FILE
...
module alt_int2fp (
	...
	alt_int2fp_altfp_convert	alt_int2fp_altfp_convert_component (
				.aclr (aclr),
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
